...
- [base/](./base): General styles affecting the whole application.
- [layout/](./layout): Styles for areas/components related to the layout of the application, such as `top-menu`, `footer`, marketing pages, etc.
- [module/](./module): Styles for specialized components (such as buttons, code, labels, etc.) and specific pages (such as API list page, "Features" page, etc.).
...
For each area/component, there is a sub-directory in either `layout/` or `module/`.
